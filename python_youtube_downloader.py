...
CTkButton(master, text='Download', command=lambda *args: download_video(entry.get())).grid(row=1, column=1, columnspan=2)
label = CTkLabel(master, text="Author: Chinthala Vijaya Kumar",fg_color=("red", "gray75"))
